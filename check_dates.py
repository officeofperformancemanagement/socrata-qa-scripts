...
for base, asset in assets:
    ...
    with open(download_path) as f:
        ...
        if inactive:
            print(
                "dataset doesn't have any data past the threshold of " + str(threshold)
            )
        ...
        csv.DictWriter(outfile, fieldnames=fieldnames).writerow(
            {
                ...
                "indexUpdatedAt": asset["indexUpdatedAt"]
                if "indexUpdatedAt" in asset
                else "n/a",
                "metadataUpdatedAt": asset["metadataUpdatedAt"],
                "publishedAt": asset["publicationDate"]
                if "publicationDate" in asset
                else "n/a",
                "rowsUpdatedAt": asset["rowsUpdatedAt"]
                if "rowsUpdatedAt" in asset
                else "n/a",
